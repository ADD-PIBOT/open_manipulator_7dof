...
#include "../include/open_manipulator_7dof_libs/open_manipulator_7dof.h"
...
void OpenManipulator::initOpenManipulator(bool using_actual_robot_state, STRING usb_port, STRING baud_rate, float control_loop_time, bool with_gripper)
{
  ...
  *****************************************************************************/
  ...
  addJoint("joint3",   // my name NEW JOINT MSJ
            "joint2",  // parent name
            "joint4",  // child name
            // math::vector3(0.195, 0.0, 0.030),                // relative position
            math::vector3(0.0, 0.0, 0.195),                // relative position
            math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
            Z_AXIS,    // axis of rotation
            3,         // actuator id
            M_PI,      // max joint limit (3.14 rad)
  ...
  addJoint("joint4",   // my name
            ...
            math::vector3(0.029998, 0.0, 0.097498),                // relative position
            math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
            Y_AXIS,    // axis of rotation
            4,         // actuator id
            M_PI,      // max joint limit (3.14 rad)
